...
<head>
  ...
  <title>E-learning | Adaptive</title>
  ...
  <!-- Font Awesome -->
  <link rel="stylesheet" href="{{asset('adminlte-v2')}}/font-awesome/css/font-awesome.min.css">
  <!-- Ionicons -->
  <link rel="stylesheet" href="{{asset('adminlte-v2')}}/Ionicons/css/ionicons.min.css">
  <!-- Theme style -->
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="../../index2.html" class="logo">
      ...
      <span class="logo-lg"><b>E-learning</b>
    </a>
  ...
  <aside class="main-sidebar">
    ...
    <section class="sidebar">
      ...
      @include('elearning.v_nav_elearning')
    </section>
  ...
  <footer class="main-footer">
    ...
    <strong>Copyright &copy; 2014-2019 <a href="https://adminlte.io">E-learning</a>.</strong> All rights
    reserved.
  </footer>
